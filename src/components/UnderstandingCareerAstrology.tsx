    ...
    <section id="understanding-career-astrology" className="py-16 lg:py-24 bg-[#FAF7F2] text-stone-800 relative overflow-hidden border-b border-stone-200">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          {/* ================= RIGHT COLUMN (SINGLE POSTER IMAGE) ================= */}
          <div className="lg:col-span-5 w-full flex justify-center">
            <div className="relative w-full max-w-[460px] rounded-3xl overflow-hidden shadow-2xl shadow-stone-900/25 border-2 border-[#EADBCA] bg-[#FAF6F0] group">
              {/* Single Consolidated Career Astrology Poster Image */}
              <img
                src={posterImage}
                alt="Career Astrology - Discover the Right Path, Timing & Growth with Acharya Ganesh"
                className="w-full h-auto object-cover block group-hover:scale-[1.02] transition-transform duration-500 cursor-pointer"
                onClick={() => onOpenBooking('executive')}
              />

              {/* Subtle top golden sheen border overlay */}
